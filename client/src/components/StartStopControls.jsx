    ...
    return (
        <div className="  ">
            <div className="flex items-center justify-between p-3 bg-white rounded-2xl ">
                ...
                <button onClick={() => { setIsShowing((prevd) => !prevd)  }} type="button" 
                className="cursor-pointer h-15 w-15 rounded-2xl bg-amber-300 hover:bg-amber-900 flex items-center justify-center text-4xl">
